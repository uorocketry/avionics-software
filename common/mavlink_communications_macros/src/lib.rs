// TODO: Standardize use of proc_macro2 crate over proc_macro
...
use proc_macro::{Ident, TokenStream, token_stream};
use proc_macro2::Group;
use quote::{quote, quote_spanned};
use syn::{
	Data, DeriveInput, Expr, Fields, GenericArgument, GenericParam, LitBool, Meta, MetaList, MetaNameValue, Pat, PathArguments, Type, parenthesized,
	parse, parse_macro_input, parse2, token::Static,
};
			...
			for x in &type_data.path.segments {
				if x.ident == "RingBuffer" {
					...
					if let PathArguments::AngleBracketed(arguments) = x.arguments.clone() {
						...
						// TODO: Add error shit for this block:
