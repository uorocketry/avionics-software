...
use mavlink::{
    ...
    common::{
        HEARTBEAT_DATA, MavAutopilot, MavComponent, MavMessage, MavMode, MavModeFlag, MavState,
        MavType,
    },
...
impl MavlinkServiceTx {
    ...
    pub async fn write_internal(&mut self, num_of_bytes: usize) {
        // info!("Internal Buffer {:?}", self.write_buffer);
        self.io_service
            .write(&self.write_buffer[0..num_of_bytes])
            .await;
    }
    ...
    pub async fn write_raw(&mut self, buf: &[u8]) {
