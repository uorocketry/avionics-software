use defmt::info;
use uor_mavlink_macros::Subscriber;
use utils::data_structures::ring_buffer::RingBuffer;

use crate::uor_mavlink_communications_traits::subscriber::Subscriber;
use crate::uor_mavlink_dialect::{MAVLinkV2MessageRaw, MavHeader, common::RADIO_STATUS_DATA};
