...
//     pub shared_resources: &'b mut crate::app::__rtic_internal_run_sm_Context<'a>,
// }
pub struct StateMachine {
    state: TemperatureBoardState,
}
...
impl StateMachine {
    ...
    pub fn run<'a, 'b>(&mut self, context: &'b mut crate::app::__rtic_internal_run_sm_Context<'a>) {
    ...
    pub fn get_state(&self) -> TemperatureBoardState {
        self.state.clone()
    }
}
...
pub enum TemperatureBoardState {
    Collection,
    Calibration, 
    Discovery,
    Idle, 
...
impl From<messages::state::State> for TemperatureBoardState {
...
impl From<TemperatureState> for messages::state::State {
