...
use crate::temperature::config::TEMPERATURE_READING_QUEUE_SIZE;
...
pub type ThermocoupleReadingQueue =
	Channel<CriticalSectionRawMutex, (AdcDevice, ThermocoupleChannel, ThermocoupleReading), TEMPERATURE_READING_QUEUE_SIZE>;
